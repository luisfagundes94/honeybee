...
private val mediaToBeDeleted = listOf(
    Media(id = 1L, uri = "", dateAdded = 0L, size = 1024L, isVideo = false),
    Media(id = 2L, uri = "", dateAdded = 0L, size = 2048L, isVideo = true),
    Media(id = 3L, uri = "", dateAdded = 0L, size = 4096L, isVideo = false)
)
