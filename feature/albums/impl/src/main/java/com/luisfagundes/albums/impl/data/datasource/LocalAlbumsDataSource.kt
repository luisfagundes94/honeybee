package com.luisfagundes.albums.impl.data.datasource
...
internal class LocalAlbumsDataSource @Inject constructor(
    @param:ApplicationContext private val context: Context,
    @param:IoDispatcher private val dispatcher: CoroutineDispatcher,
    private val subscriptionProvider: SubscriptionProvider
) {
    suspend fun fetchMediaList(): Result<List<AlbumMediaDto>> = withContext(dispatcher) {
        val mediaList = mutableListOf<AlbumMediaDto>()
